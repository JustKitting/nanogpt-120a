...
use rust_kernels_cuda::mlp::{MlpModule, MlpUpRelu2Args};
...
use super::{HiddenStateDevice, HiddenStateNvfp4, MlpDownLinear, MlpUpLinear};
...
impl MlpWeights {
    ...
    pub fn input_from_attention<'a, 'scratch>(
        ...
        up: MlpUpTensors<'a>,
        activation: &'scratch mut DeviceBuffer<f32>,
