...
#[inline(always)]
pub(super) fn load_a_pack_aligned(
    bytes: &[u8],
    tile: Nvfp4ProjectionCtaTile,
    offset: u32,
    k_base: u32,
...
#[inline(always)]
pub(super) fn load_b_pack_aligned(
    bytes: &[u8],
    tile: Nvfp4ProjectionCtaTile,
    offset: u32,
    k_base: u32,
...
#[inline(always)]
pub(super) fn load_a_scale_aligned(
    scales: &[u8],
    tile: Nvfp4ProjectionCtaTile,
    offset: u32,
    k_base: u32,
...
#[inline(always)]
pub(super) fn load_b_scale_aligned(
    scales: &[u8],
    tile: Nvfp4ProjectionCtaTile,
    offset: u32,
    k_base: u32,
