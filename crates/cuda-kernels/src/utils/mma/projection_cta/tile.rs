...
pub const NVFP4_PROJECTION_CTA_A_SCALES: usize = NVFP4_PROJECTION_CTA_M as usize;
pub const NVFP4_PROJECTION_CTA_B_SCALES: usize = NVFP4_PROJECTION_CTA_N as usize;
