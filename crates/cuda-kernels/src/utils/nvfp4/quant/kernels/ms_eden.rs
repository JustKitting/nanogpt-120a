...
pub(crate) mod module {
    ...
    fn fp32_to_nvfp4_ms_eden_body_no_chunk_amax_no_pad_pow2(
        ...
        let lane = warp::lane_id();
        let (input, row, first_chunk_in_row) = hadamard_input_no_pad_pow2(
            x,
            chunk,
            lane,
            src_row_len,
    ...
    fn fp32_transpose_to_nvfp4_ms_eden_body_no_chunk_amax_no_pad(
        ...
        let lane = warp::lane_id();
        let (input, row, first_chunk_in_row) = transposed_hadamard_input_no_pad(
            x,
            chunk,
            lane,
            source_cols,
    ...
    #[inline(always)]
    fn transposed_hadamard_input_no_pad_pow2(
        x: &[f32],
        chunk: u32,
        lane: u32,
        source_cols: u32,
    ...
    #[inline(always)]
    fn transposed_hadamard_input_no_pad(
        x: &[f32],
        chunk: u32,
        lane: u32,
        source_cols: u32,
