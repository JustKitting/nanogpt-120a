...
use super::cta_stage_f32_transposed::stage_tiles_f32_a_transposed_half_rhs;
...
pub(super) fn cta_matmul_f32_a_transposed_half_rhs_body(
    a: &[f32],
    rhs: &[u16],
    ...
    let mut k_base = 0;
    while k_base < k {
        stage_tiles_f32_a_transposed_half_rhs(a, rhs, a_tile, b_tile, tile, m, n, k, k_base);
        thread::sync_threads();
