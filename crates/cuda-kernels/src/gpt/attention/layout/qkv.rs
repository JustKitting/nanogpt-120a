...
pub(crate) fn qkv_index(
    row: u32, head: u32, dim: u32, section_offset: u32, params: &CausalAttentionParams,
) -> usize {
...
pub(crate) fn batched_qkv_index(
    ...
    qkv_index(row_index(batch, token, params), head, dim, section_offset, params)
}
...
pub(super) fn qkv_index_from_shape(
    row: u32, head: u32, dim: u32, section_offset: u32, qkv_dim: u32, head_dim: u32,
) -> usize {
