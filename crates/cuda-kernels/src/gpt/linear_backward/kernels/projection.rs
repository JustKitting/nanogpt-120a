...
pub(super) mod module {
    ...
    pub fn linear_backward_projection_pair_cta_device_scale_kernel(
        ...
        macro_rules! row_pair_tiles {
            () => {
                ProjectionCtaRowPairTiles {
                    a0_packs: unsafe { &mut A_PACKS },
                    a1_packs: unsafe { &mut A1_PACKS },
                    b_packs: unsafe { &mut B_PACKS },
                    a0_scales: unsafe { &mut A_SCALES },
                    a1_scales: unsafe { &mut A1_SCALES },
                    b_scales: unsafe { &mut B_SCALES },
                }
            };
        }
